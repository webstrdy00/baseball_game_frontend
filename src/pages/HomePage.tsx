...
import styles from "../components/tetris/CreateTetrisGame.module.css";
    ...
    <div className="py-12">
      <div className="text-center mb-12 animate-slide-up">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          다양한 미니게임을 즐겨보세요! 숫자야구, 테트리스 등 재미있는 게임이
          여러분을 기다립니다.
        </p>
      </div>
      ...
      <div className="max-w-lg mx-auto bg-white rounded-lg shadow-md p-8 mb-10 animate-fade-in">
        {isAuthenticated ? (
          ...
          <div>
            <p className="mb-6 text-lg">
              게임을 시작하려면 로그인하거나 회원가입하세요. 게스트로도 플레이할
              수 있지만, 게임 기록은 저장되지 않습니다.
            </p>
      ...
      <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 animate-fade-in">
            <p className="mb-4">
              컴퓨터가 생성한 숫자를 맞추는 추리 게임입니다. 스트라이크와 볼
              힌트를 활용해 정답을 찾아보세요!
            </p>
        ...
        <div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 animate-fade-in">
            <p className="mb-4">
              떨어지는 블록을 조작하여 라인을 맞추고 점수를 얻는 클래식
              게임입니다. 얼마나 높은 점수를 기록할 수 있을까요?
            </p>
            <div className="flex justify-center">
              <Link to="/tetris" className={styles.startButton}>
                테트리스 시작하기
              </Link>
            </div>
          </div>
