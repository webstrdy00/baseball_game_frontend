        ...
        {isAuthenticated ? (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link 
                to="/game" 
                className="flex items-center justify-center bg-primary-600 text-white py-3 px-4 rounded-lg hover:bg-primary-700 transition"
              >
              ...
              <Link 
                to="/profile" 
                className="flex items-center justify-center bg-green-600 text-white py-3 px-4 rounded-lg hover:bg-green-700 transition"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <div className="mt-4">
              <Link 
                to="/game" 
                className="flex items-center justify-center bg-gray-200 text-gray-800 py-3 px-4 rounded-lg hover:bg-gray-300 transition w-full"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
